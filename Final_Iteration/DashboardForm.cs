...
public class DashboardForm : Form
{
    private Label cardText;
     private MiniGame miniGame; // Declare MiniGame instance

    //this is a custom  class will be used in other classes
    public delegate void DataChangedEventHandler(object sender, EventArgs e);  
    public event DataChangedEventHandler DataChanged;
    private Panel transactionListContent;
    public delegate void MiniGamesEventHandler(object sender, EventArgs e);  
    public event MiniGamesEventHandler MiniGamesClicked;
    ...
    private void InitializeComponents()
    {
        ...
        // Adjust the BackColor if necessary to ensure the image is visible
        this.BackColor = Color.FromArgb(200, 200, 200); // Semi-transparent background color
        // Main layout panel
        ...
        // Smaller card panel for content and buttons jaha par PKR wagera show hoga 
        ...
        var miniGamesButton = CreateTabButton("BigBag Games", new Point(0, 60 * buttonNames.Length), MiniGamesButton_Click);
        tabsPanel.Controls.Add(miniGamesButton);
    ...
    {
        MiniGamesClicked?.Invoke(this, EventArgs.Empty);
    }
    // private void MiniGamesButton_Click(object sender, EventArgs e)
    // {
    //     // Add your MiniGames functionality here
    //     MessageBox.Show("MiniGames option clicked!");
    //     miniGame.StartGame();
    // }
    ...
    private void MiniGamesButton_Click(object sender, EventArgs e)
{
    ...
    // {
    //     // Exit the mini-game (call this method when the mini-game's exit button is clicked)
    //     miniGame.ExitGame();
    // }
